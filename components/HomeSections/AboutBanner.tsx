...
export const AboutBanner = ({
  ...
  return (
    <section className="min-h-300 relative my-24 mb-24 bg-secondary-dark2 py-12 px-12 shadow-2xl shadow-secondary-dark">
      <div className="container grid gap-12 px-0 md:grid-cols-2 md:px-24">
